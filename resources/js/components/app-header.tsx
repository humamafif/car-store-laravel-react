                                                        ...
                                                        <>
                                                            <div className="divide-y">
                                                                {cart.map((item) => (
                                                                    <div key={item.id} className="flex items-center gap-3 py-2">
                                                                        <img
                                                                            src={`/storage/${item.car.image}`}
                                                                            alt={item.car.title}
                                                                            className="h-12 w-12 rounded border object-cover"
                                                                        />
                                                                        <div className="flex-1">
                                                                            <div className="font-medium">{item.car.title}</div>
                                                                            <div className="text-muted-foreground text-xs">
                                                                                {item.quantity} x Rp{item.car.price.toLocaleString('id-ID')}
                                                                            </div>
                                                                        </div>
                                                                        <div className="flex flex-col items-end gap-1">
                                                                            <div className="text-sm font-semibold">
                                                                                Rp{(item.quantity * item.car.price).toLocaleString('id-ID')}
                                                                            </div>
                                                                            <button
                                                                                type="button"
                                                            ...
                                                            <div className="mt-3 flex items-center justify-between font-semibold">
                                                                ...
                                                                <span>
                                                                    Rp
                                                                    {cart
                                                                        .reduce((sum, item) => sum + item.quantity * item.car.price, 0)
                                        ...
                                        {cart.length === 0 ? (
                                            ...
                                            <>
                                                ...
                                                <div className="mt-3 flex items-center justify-between font-semibold">
                                                    ...
                                                    <span>
                                                        Rp
                                                        {cart.reduce((sum, item) => sum + item.quantity * item.car.price, 0).toLocaleString('id-ID')}
                                                    </span>
                                                </div>
                                                <Button
                                                    className="mt-4 w-full"
